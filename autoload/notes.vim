...
function notes#FindWinNumID(id)
...
function! s:open_window(position,note)
	...
	let g:notes_winnr = notes#FindWinNumID('note')
	...
	if winnr() == notes#FindWinNumID('note') | nnoremap <C-N> :NNEXT <CR> | endif
	if winnr() == notes#FindWinNumID('note')  | nnoremap <C-P> :PPREVIOUS <CR> | endif
endfunction
